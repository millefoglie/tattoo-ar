...
import com.example.tattoo_ar.view.recognition.ErrorCode
import com.example.tattoo_ar.view.recognition.ImageRecognitionListener
...
class AugmentedView(
    ...
    private val recognizer: AugmentedImageRecognizer,
    private val methodChannel: MethodChannel,
) : GLSurfaceView(context), PlatformView {
    companion object {
        val TAG = AugmentedView::class.simpleName
    }
